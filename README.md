...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pcpp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13339&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pcpp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pcpp` can be installed with:

```
conda install pcpp
```

It is possible to list all of the versions of `pcpp` available on your platform with:
